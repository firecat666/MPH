...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Dia'), array('action' => 'delete', $dia['Dia']['id']), array(), __('Are you sure you want to delete # %s?', $dia['Dia']['id'])); ?> </li>
...
<div class="related">
	...
	<?php foreach ($dia['Asignacione'] as $asignacione): ?>
		<tr>
