...
<table id="tblAsig">
    <thead>
        ...
        <tr style="display: none"><td></td><td></td><td></td><td></td><td></td><td id="acciones"><?php echo $this->Html->link('Asignar', ['action' => 'asignar'], ['class' => 'asignar']) ?><?php echo $this->Html->link('Modificar', ['action' => 'editar'], ['class' => 'editar']) ?></td></tr>
    </thead>
    <tbody>
