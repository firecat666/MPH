...
<div class="actions">
    ...
    <ul>
        ...
        <li><?php echo $this->Form->postLink(__('Borrar'), array('action' => 'delete', $this->Form->value('Tipoaula.id')), array(), __('¿Esta seguro que desea borrar %s?', $this->Form->value('Tipoaula.tipo'))); ?></li>
