...
class PhpExcelHelper extends AppHelper {
     ...
     * Merge Cells
     * 
     * @param array $cells array of cells to merge
     * @return type Description
     */
    public function mergeCells($start, $finish) {
        $this->_xls->setActiveSheetIndex(0)->mergeCells($start . ':' . $finish);
        //return $this;
    }

    public function setStyleToRange($range, $style) {
